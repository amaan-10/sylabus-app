              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 w-full">
                {papers.map((paper) => (
                  <Link
                    ...
                    key={paper._id}
                    className="rounded-xl mb-2 border border-slate-200 bg-[#f1f5f9] p-4 shadow-sm hover:shadow transition"
                  >
                    <svg
                      viewBox="-4 0 40 40"
                      fill="none"
                    ...
                    <div className="mt-3 space-y-1 text-xs text-slate-600">
                      <div className="flex items-center gap-1">
                        ...
                        {paper.questions.length} Questions • {paper.totalMarks}{" "}
                        Marks
                      </div>
                      ...
                      <span className="inline-block mt-1 rounded-full bg-emerald-100 px-2 py-0.5 text-[11px] font-semibold text-emerald-800">
                        {paper.paperMode === "exam" ? "Exam Pattern" : "Custom"}
                      </span>
                    </div>
